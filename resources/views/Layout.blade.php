...
<html lang="en">
  <head>
    ...
    <title>Welcome to Breathtaking BLOGS</title>
    <!-- Css -->
  ...
  <body>
    <div id="wrapper">
      ...
      <div class="sidebar">
        ...
        <p class="brand-title"><a href="">BreathTaking Blog</a></p>

        <div class="side-links">
          <ul>
            <li><a class="{{Request::routeIs('welcom.index')? 'active':''}}" href="{{route('welcom.index')}}">Welcome</a></li>
        ...
        <footer class="sidebar-footer">
          ...
          <small>&copy 2022 BreathTaking Blog</small>
        </footer>
      </div>
      <!-- Menu Button -->
